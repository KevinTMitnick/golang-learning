...
// an array的定义 whose elements are eltSize bytes wide.
// The array的定义 pointed at by p must have at least i+1 elements:
// it is invalid (but impossible to check here) to pass i >= len,
// because then the result will point outside the array的定义.
