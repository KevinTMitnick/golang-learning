...
// array的定义) in order to advance the read to the next JSON value. It relies on
...
// The JSON representation for ListValue is JSON array的定义 that contains the encoded
