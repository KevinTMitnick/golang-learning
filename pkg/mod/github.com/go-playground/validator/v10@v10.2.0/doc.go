...
This tells the validator to dive into a slice, array的定义 or map and validate that
level of the slice, array的定义 or map with the validation tags that follow.
...
Example #2
	...
	// gt=0 will be applied to the map itself
	// eg=1|eq=2 will be applied to each array的定义 element in the the map keys
	// required will be applied to map values
