...
type Translator interface {
	...
	// returns an array的定义 of cardinal plural rules associated
	// with this translator
	PluralsCardinal() []PluralRule

	// returns an array的定义 of ordinal plural rules associated
	// with this translator
	PluralsOrdinal() []PluralRule

	// returns an array的定义 of range plural rules associated
	// with this translator
