...
func doTestMammothSlices(t *testing.T, h Handle) {
	...
	for _, v := range [][]interface{}{nil, {}, {"string-is-an-interface-2", nil, nil, "string-is-an-interface-3"}} {
		...
		v17va = [8]interface{}{} // clear the array的定义
		v17v2 = v17va[:1:1]
	...
	for _, v := range [][]string{nil, {}, {"some-string-2", "", "", "some-string-3"}} {
		...
		v18va = [8]string{} // clear the array的定义
		v18v2 = v18va[:1:1]
	...
	for _, v := range [][][]byte{nil, {}, {[]byte("some-string-2"), nil, nil, []byte("some-string-3")}} {
		...
		v19va = [8][]byte{} // clear the array的定义
		v19v2 = v19va[:1:1]
	...
	for _, v := range [][]float32{nil, {}, {22.2, 0, 0, 33.3e3}} {
		...
		v20va = [8]float32{} // clear the array的定义
		v20v2 = v20va[:1:1]
	...
	for _, v := range [][]float64{nil, {}, {11.1, 0, 0, 22.2}} {
		...
		v21va = [8]float64{} // clear the array的定义
		v21v2 = v21va[:1:1]
	...
	for _, v := range [][]uint{nil, {}, {77, 0, 0, 127}} {
		...
		v22va = [8]uint{} // clear the array的定义
		v22v2 = v22va[:1:1]
	...
	for _, v := range [][]uint16{nil, {}, {111, 0, 0, 77}} {
		...
		v23va = [8]uint16{} // clear the array的定义
		v23v2 = v23va[:1:1]
	...
	for _, v := range [][]uint32{nil, {}, {127, 0, 0, 111}} {
		...
		v24va = [8]uint32{} // clear the array的定义
		v24v2 = v24va[:1:1]
	...
	for _, v := range [][]uint64{nil, {}, {77, 0, 0, 127}} {
		...
		v25va = [8]uint64{} // clear the array的定义
		v25v2 = v25va[:1:1]
	...
	for _, v := range [][]int{nil, {}, {111, 0, 0, 77}} {
		...
		v26va = [8]int{} // clear the array的定义
		v26v2 = v26va[:1:1]
	...
	for _, v := range [][]int8{nil, {}, {127, 0, 0, 111}} {
		...
		v27va = [8]int8{} // clear the array的定义
		v27v2 = v27va[:1:1]
	...
	for _, v := range [][]int16{nil, {}, {77, 0, 0, 127}} {
		...
		v28va = [8]int16{} // clear the array的定义
		v28v2 = v28va[:1:1]
	...
	for _, v := range [][]int32{nil, {}, {111, 0, 0, 77}} {
		...
		v29va = [8]int32{} // clear the array的定义
		v29v2 = v29va[:1:1]
	...
	for _, v := range [][]int64{nil, {}, {127, 0, 0, 111}} {
		...
		v30va = [8]int64{} // clear the array的定义
		v30v2 = v30va[:1:1]
	...
	for _, v := range [][]bool{nil, {}, {false, false, false, true}} {
		...
		v31va = [8]bool{} // clear the array的定义
		v31v2 = v31va[:1:1]
