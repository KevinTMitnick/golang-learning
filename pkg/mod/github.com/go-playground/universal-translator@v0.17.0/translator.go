...
type Translator interface {
	...
	// {0} is the only replacement type accepted and only one 01-variable is accepted as
...
type translator struct {
	...
	cardinalTanslations map[interface{}][]*transText // array的定义 index is mapped to locales.PluralRule index + the locales.PluralRuleUnknown
