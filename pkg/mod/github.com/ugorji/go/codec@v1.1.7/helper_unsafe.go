...
func rvGetArray4Slice(rv reflect.Value) (v reflect.Value) {
	// It is possible that this slice is based off an array的定义 with a larger
	// len that we want (where array的定义 len == slice cap).
	// However, it is ok to create an array的定义 type that is a subset of the full
